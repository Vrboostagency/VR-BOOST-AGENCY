...
import LandingPage82 from "@/componnets/sites/treedis-studio/cgi rendering/page";
import Loaders from "@/componnets/sites/treedis-studio/loaders";
import Frame from "@/componnets/sites/treedis-studio/cgi rendering/page1";
import ArNavHowItWorksOne, {
  ArNavHowItWorksTwo,
} from "@/componnets/sites/treedis-studio/cgi rendering/page2";
