...
import LandingPage82 from "@/componnets/sites/treedis-studio/Capture Services/page";
import Loaders from "@/componnets/sites/treedis-studio/loaders";
import Frame from "@/componnets/sites/treedis-studio/Capture Services/page1";
import ArNavHowItWorksOne, {
  ArNavHowItWorksTwo,
} from "@/componnets/sites/treedis-studio/Capture Services/page2";
  ...
  return  (
    <>
      <div className="tds-page w-full">
        {/* section 0 Menu*/}
        <Navbar />
        {/* section 0.05 hero, before loader page.tsx */}
        <LandingPage82 />
        {/* section 0.1 loaders icons */}
        <Loaders />       
         {/* section 1 Navigation */}
         {/* section 2 How it works page1.tsx*/}
         <Frame />
         {/* section 3 advanced and interactive page2.tsx*/}
         <ArNavHowItWorksOne />
         <ArNavHowItWorksTwo />
         {/* section 4 Demo*/}
          <Demo />
